...
namespace Match3
{
    ...
    public class VFXController : MonoBehaviour
    {
        ...
        public void Trigger(string name, Vector3 position, Transform parent = null, TileBase tileOverride = null)
        {
            Trigger(StringToHash(name), position, 0, false, parent, tileOverride);
        }
